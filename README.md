...
**Hosting**: Vercel  
**Repository**: GitHub (main branch)  
**Services**: Clerk (Auth), Supabase (Database), Resend (Email)

### Required Environment Variables

Configure these in Vercel (Settings → Environment Variables) or in `.env.local` for local development:
...
SUPABASE_SERVICE_ROLE_KEY=eyJhbGci... # For API routes (Sensitive)
SUPABASE_JWT_SECRET=your_jwt_secret # For JWT verification (Sensitive)

# ============================================
# Postgres (Supabase Connection Strings)
# ============================================
# These are typically auto-generated by Supabase
# Scope: Production
...
POSTGRES_PASSWORD=your_password # Sensitive
...
# ============================================
# Brandfetch API (Brand Search)
# ============================================
# Get from https://brandfetch.com
...
**Current Configuration** (as of v4.1.0):
- **Clerk**: `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY`, `CLERK_SECRET_KEY` (All Environments)
- **Supabase**: `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `SUPABASE_URL`, `SUPABASE_ANON_KEY`, `SUPABASE_SERVICE_ROLE_KEY`, `SUPABASE_JWT_SECRET` (Production)
- **Postgres**: `POSTGRES_URL`, `POSTGRES_PRISMA_URL`, `POSTGRES_URL_NON_POOLING`, `POSTGRES_USER`, `POSTGRES_HOST`, `POSTGRES_PASSWORD`, `POSTGRES_DATABASE` (Production)
