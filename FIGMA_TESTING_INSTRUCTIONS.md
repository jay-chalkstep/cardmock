# Testing Instructions for CardMock Figma Integration

## Overview
CardMock is a design approval and collaboration platform that allows users to import Figma frames directly into approval workflows.
...
2. An CardMock account (created via sign-up above)

## Testing Steps

### Step 1: Connect Figma Account
1. Log in to CardMock at https://app.cardmock.com
...
5. Verify you are redirected back to CardMock with a success message
6. Verify the connection status shows "Connected"

### Step 2: Import Figma Frames
1. In CardMock, navigate to Library → Assets tab
...
- Imported frames should appear as assets in CardMock with correct images
...
- Verify the sign-up URL is accessible: https://app.cardmock.com/sign-up
...
- Check that the redirect URI matches: `https://app.cardmock.com/api/integrations/figma/callback`
...
- Imported assets are stored in CardMock and can be managed independently from the source Figma file
